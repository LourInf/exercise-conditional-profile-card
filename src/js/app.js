 ...
 * 
    {
        includeCover: true, // if includeCover is true the algorithm should show the cover image. False to not include
...
function render(variables = {}) {
  ...
  // Dynamically set the city and country based on variables

  // reset the website body with the new html output
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
            ${cover}
          <img src="${variables.avatarURL}" class="photo" />
          <h1>${variables.name ? variables.name : ""}<span> ${
